...
class Delivery(models.Model):
    ...
    - comments (ManyToManyField):  Comments that have been added to the delivery.
    - generated_context (TextField): Additional context generated by application.
    - invoice_pdf (FileField): Field to store the invoice PDF
    ...
    invoice_pdf = models.FileField(upload_to='documents/invoice_pdfs/', null=True, blank=True)
